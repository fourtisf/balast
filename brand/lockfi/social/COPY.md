# LockFi on X: the introduction series

Six posts and a profile header, from `npm run brand:social`
(`scripts/build-lockfi-social.mjs`). They use the site's own design: black
logo tile, signal blue, Instrument Sans, and the site's components with their
numbers left out.
